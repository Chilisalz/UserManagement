...
namespace UserManagementService.Migrations
{
    ...
    [Migration("20211121175119_UserSecretAdded")]
    partial class UserSecretAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagementService.Models.ChiliUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEK0fJlW/cn+346r0wreDXMO9vjUl1AtwqC//XIoW4RESARd78sapmEjAnz+UzUMYDA==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2021, 11, 21, 18, 51, 18, 405, DateTimeKind.Local).AddTicks(8207),
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDbRoA4UqChjY2WLD8MSHjLOgbo8oY15oMiSc3flezrfAmAe40XLWGKfDP6NZ2pjMg==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2021, 11, 21, 18, 51, 18, 409, DateTimeKind.Local).AddTicks(3241),
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMS19rs4jDcplE4Wg3OspGEipKzd2ZBBJ4dWyOoFi/A2hYURDHXnOxuBIGsQNC1KLw==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2021, 11, 21, 18, 51, 18, 409, DateTimeKind.Local).AddTicks(3319),
            ...
            modelBuilder.Entity("UserManagementService.Models.ChiliUserSecretAnswer", b =>
                {
            ...
            modelBuilder.Entity("UserManagementService.Models.ChiliUserSecretQuestion", b =>
                {
                    b.Property<Guid>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserManagementService.Models.ChiliUserSecretAnswer", b =>
                {
                    b.HasOne("UserManagementService.Models.ChiliUserSecretQuestion", "SecretQuestion")
                        .WithMany()
