...
namespace UserManagementService.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<ChiliUser> userManager, JWTSettings jwtSettings)
        {
        ...
        private AuthenticationResult GenerateAuthenticationResultForUser(ChiliUser newUser)
        {
